...
class TestNetworkManagerActivatorBringUp:
    def fake_isfile_no_nmconn(filename):  # pylint: disable=no-self-argument,no-member  # pylint: disable=no-self-argument,no-member  # pylint: disable=no-self-argument
